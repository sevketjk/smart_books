...
String slectedCategorie = "lets contuine";
...
{
  List<String> categories = ["lets contuine",];
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Text("hi sevket orak!", style: TextStyle(
                ...
                SizedBox(height: 16,),
                Image.asset("assets/banner.jpg",fit: BoxFit.fitWidth,),
                SizedBox(height: 30,),
                Container(
                  padding: EdgeInsets.symmetric(horizontal: 12),
                  height: 40,
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            ...
            // eklemeleri buraya yapacağız singleScroll altına dataları tanımlayıp burya containerleri gireceğiz.
         ],
        ),
      ),
    );
